...
% custom begin
% these files MUST NOT be empty, i.e., they must always contain at least 1 entry
% custom end
...
% CUSTOM BEGIN
% Must be reloaded here, probably because style.tex (includes style-srcpage2.tex) is included before geometry package. Hence 
% the style did not consider the changes by geometry.
% Ensures correct sizes for the header and footer.
\input{preamble/style-scrpage2.tex}

%\frontmatter % TODO: enable?
\pagestyle{plain}
...
\frontmatter % TODO: disable?
\IfPackageLoaded{scrpage2}{\pagestyle{scrheadings}} % TODO: Remove??

% -- table of contents --
%
% add table of contents to pdf bookmarks
\IfPackageLoaded{hyperref}{\pdfbookmark[1]{\contentsname}{toc}} % TODO: Remove??
\tableofcontents
